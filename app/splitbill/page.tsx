    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-white border-y border-gray-100">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          {/* 頼み方と返ってくるものを、そのまま会話で見せる (手順は繋ぐページに書いてある) */}
          <div className="max-w-2xl mx-auto mb-8">
            <div className="flex justify-end mb-3">
              <p className="max-w-[85%] rounded-2xl rounded-br-sm px-4 py-3 text-sm text-white leading-relaxed whitespace-pre-line"
            ...
            <div className="flex items-start gap-2">
              ...
              <p className="max-w-[85%] rounded-2xl rounded-bl-sm bg-gray-100 px-4 py-3 text-sm text-gray-800 leading-relaxed whitespace-pre-line break-words">
                {c.mcpChatAi}
              </p>
            </div>
          </div>

          <p className="text-sm text-gray-600 text-center max-w-2xl mx-auto mb-8 leading-relaxed">
            {c.mcpHowNote}
          </p>
